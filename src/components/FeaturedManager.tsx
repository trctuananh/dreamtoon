      ...
      {isAdding && (
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm">
            <h3 className="text-lg font-bold mb-4 flex items-center gap-2"><Compass size={20} className="text-blue-500" /> Comics</h3>
          ...
          <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm">
            <h3 className="text-lg font-bold mb-4 flex items-center gap-2"><Layout size={20} className="text-purple-500" /> Articles</h3>
            <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
      ...
      <div className="grid gap-4">
        ...
        {featuredItems.length === 0 && (
          <div className="text-center py-20 bg-zinc-50 rounded-[40px] border-2 border-dashed border-zinc-200">
            ...
            <p className="text-zinc-500 font-medium">No featured items yet.</p>
          </div>
        )}
      </div>
    </div>
